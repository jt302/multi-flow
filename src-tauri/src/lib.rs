...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::bookmark_commands::get_profile_bookmarks,
            commands::bookmark_commands::create_profile_bookmark,
            commands::bookmark_commands::create_profile_bookmark_folder,
            commands::bookmark_commands::update_profile_bookmark,
            commands::bookmark_commands::move_profile_bookmark,
            commands::bookmark_commands::remove_profile_bookmark,
            commands::bookmark_commands::export_profile_bookmarks,
            commands::bookmark_commands::import_bookmarks_to_profile,
            commands::bookmark_commands::list_bookmark_templates,
            commands::bookmark_commands::create_bookmark_template,
            commands::bookmark_commands::update_bookmark_template,
            commands::bookmark_commands::delete_bookmark_template,
            commands::bookmark_commands::apply_bookmark_template,
            commands::bookmark_commands::subscribe_bookmark_template,
            commands::bookmark_commands::unsubscribe_bookmark_template,
            commands::bookmark_commands::list_template_subscriptions,
            commands::bookmark_commands::list_profile_subscriptions,
            commands::bookmark_commands::diff_template_with_profile,
