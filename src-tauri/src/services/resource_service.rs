...
const DEFAULT_CHROMIUM_URL: &str =
    "https://pub-a864de27cbb94ddbb6df4bd821e5d544.r2.dev/chromium/chromium_144.0.7559.97.dmg";
const DEFAULT_GEOIP_URL: &str =
    "https://pub-a864de27cbb94ddbb6df4bd821e5d544.r2.dev/GeoLite2-City.mmdb";
