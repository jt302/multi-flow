...
const confirmSource = readFileSync(new URL('./confirm-action-dialog.tsx', import.meta.url), 'utf8');
const alertSource = readFileSync(new URL('../ui/alert-dialog.tsx', import.meta.url), 'utf8');
