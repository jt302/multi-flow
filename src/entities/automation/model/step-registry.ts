...
export const STEP_KINDS: StepKindDef[] = [
	...
	{
		value: 'magic_set_master_indicator_visible',
		label: 'magic_set_master_indicator_visible',
		group: 'window',
	},
	// 标签页
	...
	{
		value: 'magic_create_bookmark_folder',
		label: 'magic_create_bookmark_folder',
		group: 'bookmark',
	},
	...
	{
		value: 'magic_unbookmark_current_tab',
		label: 'magic_unbookmark_current_tab',
		group: 'bookmark',
	},
	{
		value: 'magic_is_current_tab_bookmarked',
		label: 'magic_is_current_tab_bookmarked',
		group: 'bookmark',
	},
	...
	// 扩展
	{
		value: 'magic_get_managed_extensions',
		label: 'magic_get_managed_extensions',
		group: 'extension',
	},
	{
		value: 'magic_trigger_extension_action',
		label: 'magic_trigger_extension_action',
		group: 'extension',
	},
	{
		value: 'magic_close_extension_popup',
		label: 'magic_close_extension_popup',
		group: 'extension',
	},
	// 同步模式
...
export const KIND_GROUPS: Record<string, string> = {
	...
	cdp_type: 'cdp',
	cdp_scroll_to: 'cdp',
	cdp_wait_for_selector: 'cdp',
	cdp_wait_for_page_load: 'cdp',
	cdp_get_text: 'cdp',
	cdp_get_attribute: 'cdp',
	cdp_set_input_value: 'cdp',
	cdp_screenshot: 'cdp',
	cdp_open_new_tab: 'cdp',
	cdp_get_all_tabs: 'cdp',
	cdp_switch_tab: 'cdp',
	cdp_close_tab: 'cdp',
	cdp_go_back: 'cdp',
	cdp_go_forward: 'cdp',
	cdp_upload_file: 'cdp',
	cdp_download_file: 'cdp',
	cdp_clipboard: 'cdp',
	cdp_execute_js: 'cdp',
	cdp_input_text: 'cdp',
	cdp_press_key: 'cdp',
	cdp_shortcut: 'cdp',
	cdp_handle_dialog: 'cdp',
	cdp_get_browser_version: 'cdp',
	cdp_get_browser_command_line: 'cdp',
	cdp_get_window_for_target: 'cdp',
	cdp_get_layout_metrics: 'cdp',
	cdp_get_document: 'cdp',
	cdp_get_full_ax_tree: 'cdp',
	// Manual/Notification
	confirm_dialog: 'manual',
	select_dialog: 'manual',
	notification: 'notification',
	form_dialog: 'manual',
	table_dialog: 'manual',
	image_dialog: 'manual',
	countdown_dialog: 'manual',
	markdown_dialog: 'manual',
	// Window
	magic_set_bounds: 'window',
	magic_get_bounds: 'window',
	magic_set_maximized: 'window',
	magic_set_minimized: 'window',
	magic_set_closed: 'window',
	magic_safe_quit: 'window',
	magic_set_restored: 'window',
	magic_set_fullscreen: 'window',
	magic_set_bg_color: 'window',
	magic_set_toolbar_text: 'window',
	magic_set_app_top_most: 'window',
	magic_set_master_indicator_visible: 'window',
	// Tab
	magic_open_new_tab: 'tab',
	magic_close_tab: 'tab',
	magic_activate_tab: 'tab',
	magic_activate_tab_by_index: 'tab',
	magic_close_inactive_tabs: 'tab',
	magic_open_new_window: 'tab',
	magic_type_string: 'tab',
	// Browser
	magic_get_browsers: 'browser',
	magic_get_active_browser: 'browser',
	magic_get_tabs: 'browser',
	magic_get_active_tabs: 'browser',
	magic_get_switches: 'browser',
	magic_get_host_name: 'browser',
	magic_get_mac_address: 'browser',
	// Bookmark
	magic_get_bookmarks: 'bookmark',
	magic_create_bookmark: 'bookmark',
	magic_create_bookmark_folder: 'bookmark',
	magic_update_bookmark: 'bookmark',
	magic_move_bookmark: 'bookmark',
	magic_remove_bookmark: 'bookmark',
	magic_bookmark_current_tab: 'bookmark',
	magic_unbookmark_current_tab: 'bookmark',
	magic_is_current_tab_bookmarked: 'bookmark',
	magic_export_bookmark_state: 'bookmark',
	// Cookie
	magic_get_managed_cookies: 'cookie',
	magic_export_cookie_state: 'cookie',
	// Extension
	magic_get_managed_extensions: 'extension',
	magic_trigger_extension_action: 'extension',
	magic_close_extension_popup: 'extension',
	magic_enable_extension: 'extension',
	magic_disable_extension: 'extension',
	// Sync
	magic_toggle_sync_mode: 'sync',
	magic_get_sync_mode: 'sync',
	magic_get_is_master: 'sync',
	magic_get_sync_status: 'sync',
	// AI Agent 语义化操作
	...
	// Storage (cdp_*)
	cdp_get_cookies: 'storage',
	cdp_set_cookie: 'storage',
	cdp_delete_cookies: 'storage',
	cdp_get_local_storage: 'storage',
	cdp_set_local_storage: 'storage',
	cdp_get_session_storage: 'storage',
	cdp_clear_storage: 'storage',
	cdp_get_current_url: 'pageInfo',
	cdp_get_page_source: 'pageInfo',
	cdp_wait_for_navigation: 'pageInfo',
	// Device
	cdp_emulate_device: 'device',
	cdp_set_geolocation: 'device',
	cdp_set_user_agent: 'device',
	// Element
	cdp_get_element_box: 'element',
	cdp_highlight_element: 'element',
	cdp_mouse_move: 'element',
	cdp_drag_and_drop: 'element',
	cdp_select_option: 'element',
	cdp_check_checkbox: 'element',
	// Network
	cdp_block_urls: 'network',
	cdp_pdf: 'network',
	cdp_intercept_request: 'network',
	// Debug (console/network logs)
	cdp_get_console_logs: 'debug',
	cdp_get_network_requests: 'debug',
	// Window State
	magic_get_maximized: 'windowState',
	magic_get_minimized: 'windowState',
	magic_get_fullscreen: 'windowState',
	magic_get_window_state: 'windowState',
	...
	captcha_inject_token: 'captcha',
	captcha_solve_and_inject: 'captcha',
...
export function defaultStep(kind: string): ScriptStep {
	switch (kind) {
		...
		case 'magic':
			return { kind: 'magic', command: '', params: {} };
		case 'cdp':
			return { kind: 'cdp', method: '' };
		case 'wait_for_user':
			return { kind: 'wait_for_user', message: '' };
		case 'condition':
			return { kind: 'condition', condition_expr: '', then_steps: [], else_steps: [] };
		case 'loop':
			return { kind: 'loop', mode: 'count', count: 3, body_steps: [] };
		case 'break':
			return { kind: 'break' };
		case 'continue':
		...
		case 'end':
			return { kind: 'end' };
		case 'print':
			return { kind: 'print', text: '', level: 'info' };
		case 'ai_agent':
			return { kind: 'ai_agent', prompt: '', max_steps: 10 };
		case 'ai_judge':
			return { kind: 'ai_judge', prompt: '', output_mode: 'boolean' as const, max_steps: 5 };
		case 'cdp_navigate':
			return { kind: 'cdp_navigate', url: 'https://' };
		case 'cdp_reload':
			return { kind: 'cdp_reload', ignore_cache: false };
		case 'cdp_click':
			return { kind: 'cdp_click', selector: '' };
		case 'cdp_type':
			return { kind: 'cdp_type', selector: '', text: '' };
		case 'cdp_scroll_to':
			return { kind: 'cdp_scroll_to' };
		case 'cdp_wait_for_selector':
			return { kind: 'cdp_wait_for_selector', selector: '' };
		case 'cdp_wait_for_page_load':
			return { kind: 'cdp_wait_for_page_load', timeout_ms: 30000 };
		case 'cdp_get_text':
			return { kind: 'cdp_get_text', selector: '' };
		case 'cdp_get_attribute':
			return { kind: 'cdp_get_attribute', selector: '', attribute: '' };
		case 'cdp_set_input_value':
			return { kind: 'cdp_set_input_value', selector: '', value: '' };
		case 'cdp_screenshot':
			return { kind: 'cdp_screenshot', output_path: '' };
		case 'cdp_open_new_tab':
			return { kind: 'cdp_open_new_tab', url: 'https://' };
		case 'cdp_get_all_tabs':
			return { kind: 'cdp_get_all_tabs' };
		case 'cdp_switch_tab':
			return { kind: 'cdp_switch_tab', target_id: '' };
		case 'cdp_close_tab':
			return { kind: 'cdp_close_tab', target_id: '' };
		case 'cdp_go_back':
			return { kind: 'cdp_go_back', steps: 1 };
		case 'cdp_go_forward':
			return { kind: 'cdp_go_forward', steps: 1 };
		case 'cdp_upload_file':
			return { kind: 'cdp_upload_file', selector: '', files: [''] };
		case 'cdp_download_file':
			return { kind: 'cdp_download_file', download_path: '' };
		case 'cdp_clipboard':
			return { kind: 'cdp_clipboard', action: 'copy' };
		case 'cdp_execute_js':
			return { kind: 'cdp_execute_js', expression: '' };
		case 'cdp_input_text':
			return { kind: 'cdp_input_text', selector: '', text_source: 'inline', text: '' };
		case 'cdp_press_key':
			return { kind: 'cdp_press_key', key: 'Enter' };
		case 'cdp_shortcut':
			return { kind: 'cdp_shortcut', modifiers: ['ctrl'], key: 'c' };
		case 'cdp_handle_dialog':
			return { kind: 'cdp_handle_dialog', action: 'accept' };
		case 'cdp_get_browser_version':
			return { kind: 'cdp_get_browser_version' };
		case 'cdp_get_browser_command_line':
			return { kind: 'cdp_get_browser_command_line' };
		case 'cdp_get_window_for_target':
			return { kind: 'cdp_get_window_for_target' };
		case 'cdp_get_layout_metrics':
			return { kind: 'cdp_get_layout_metrics' };
		case 'cdp_get_document':
			return { kind: 'cdp_get_document', depth: 1 };
		case 'cdp_get_full_ax_tree':
			return { kind: 'cdp_get_full_ax_tree' };
		case 'confirm_dialog':
			return {
				kind: 'confirm_dialog',
				title: '',
				...
				buttons: [
					{
						text: i18next.t('automation:stepDefaults.confirm'),
						value: 'confirm',
						variant: 'default',
					},
					{
						text: i18next.t('automation:stepDefaults.cancel'),
						value: 'cancel',
						variant: 'outline',
					},
				],
		...
		case 'select_dialog':
			return {
				...
				title: '',
				options: [
					i18next.t('automation:stepDefaults.option1'),
					i18next.t('automation:stepDefaults.option2'),
				],
			};
		case 'notification':
		...
		case 'form_dialog':
			return {
				kind: 'form_dialog',
				title: '',
				fields: [{ name: 'field1', label: 'Field 1', fieldType: 'text' }],
			};
		case 'table_dialog':
			return {
				kind: 'table_dialog',
		...
		case 'image_dialog':
			return { kind: 'image_dialog', title: '', image: '' };
		case 'countdown_dialog':
			return { kind: 'countdown_dialog', title: '', message: '', seconds: 10, level: 'warning' };
		case 'markdown_dialog':
			return { kind: 'markdown_dialog', title: '', content: '' };
		case 'magic_set_bounds':
			return { kind: 'magic_set_bounds', x: 0, y: 0, width: 1280, height: 800 };
		case 'magic_get_bounds':
			return { kind: 'magic_get_bounds' };
		case 'magic_set_maximized':
			return { kind: 'magic_set_maximized' };
		case 'magic_set_minimized':
			return { kind: 'magic_set_minimized' };
		case 'magic_set_closed':
			return { kind: 'magic_set_closed' };
		case 'magic_safe_quit':
			return { kind: 'magic_safe_quit' };
		case 'magic_set_restored':
			return { kind: 'magic_set_restored' };
		case 'magic_set_fullscreen':
			return { kind: 'magic_set_fullscreen' };
		case 'magic_set_bg_color':
			return { kind: 'magic_set_bg_color', r: 255, g: 255, b: 255 };
		case 'magic_set_toolbar_text':
			return { kind: 'magic_set_toolbar_text', text: '' };
		case 'magic_set_app_top_most':
			return { kind: 'magic_set_app_top_most' };
		case 'magic_set_master_indicator_visible':
			return { kind: 'magic_set_master_indicator_visible', visible: true };
		case 'magic_open_new_tab':
			return { kind: 'magic_open_new_tab', url: 'https://' };
		case 'magic_close_tab':
			return { kind: 'magic_close_tab', tab_id: 0 };
		case 'magic_activate_tab':
			return { kind: 'magic_activate_tab', tab_id: 0 };
		case 'magic_activate_tab_by_index':
			return { kind: 'magic_activate_tab_by_index', index: 0 };
		case 'magic_close_inactive_tabs':
			return { kind: 'magic_close_inactive_tabs' };
		case 'magic_open_new_window':
			return { kind: 'magic_open_new_window' };
		case 'magic_type_string':
			return { kind: 'magic_type_string', text: '' };
		case 'magic_capture_app_shell':
			return { kind: 'magic_capture_app_shell' };
		case 'magic_get_browsers':
			return { kind: 'magic_get_browsers' };
		case 'magic_get_active_browser':
			return { kind: 'magic_get_active_browser' };
		case 'magic_get_tabs':
			return { kind: 'magic_get_tabs', browser_id: 0 };
		case 'magic_get_active_tabs':
			return { kind: 'magic_get_active_tabs' };
		case 'magic_get_switches':
			return { kind: 'magic_get_switches', key: '' };
		case 'magic_get_host_name':
			return { kind: 'magic_get_host_name' };
		case 'magic_get_mac_address':
			return { kind: 'magic_get_mac_address' };
		case 'magic_get_bookmarks':
			return { kind: 'magic_get_bookmarks' };
		case 'magic_create_bookmark':
			return { kind: 'magic_create_bookmark', parent_id: '', title: '', url: 'https://' };
		case 'magic_create_bookmark_folder':
			return { kind: 'magic_create_bookmark_folder', parent_id: '', title: '' };
		case 'magic_update_bookmark':
			return { kind: 'magic_update_bookmark', node_id: '' };
		case 'magic_move_bookmark':
			return { kind: 'magic_move_bookmark', node_id: '', new_parent_id: '' };
		case 'magic_remove_bookmark':
			return { kind: 'magic_remove_bookmark', node_id: '' };
		case 'magic_bookmark_current_tab':
			return { kind: 'magic_bookmark_current_tab' };
		case 'magic_unbookmark_current_tab':
			return { kind: 'magic_unbookmark_current_tab' };
		case 'magic_is_current_tab_bookmarked':
			return { kind: 'magic_is_current_tab_bookmarked' };
		case 'magic_export_bookmark_state':
			return { kind: 'magic_export_bookmark_state' };
		case 'magic_get_managed_cookies':
			return { kind: 'magic_get_managed_cookies' };
		case 'magic_export_cookie_state':
			return { kind: 'magic_export_cookie_state', mode: 'all' };
		case 'magic_get_managed_extensions':
			return { kind: 'magic_get_managed_extensions' };
		case 'magic_trigger_extension_action':
			return { kind: 'magic_trigger_extension_action', extension_id: '' };
		case 'magic_close_extension_popup':
			return { kind: 'magic_close_extension_popup' };
		case 'magic_enable_extension':
			return { kind: 'magic_enable_extension', extension_id: '' };
		case 'magic_disable_extension':
			return { kind: 'magic_disable_extension', extension_id: '' };
		case 'magic_toggle_sync_mode':
			return { kind: 'magic_toggle_sync_mode', role: 'master' };
		case 'magic_get_sync_mode':
			return { kind: 'magic_get_sync_mode' };
		case 'magic_get_is_master':
			return { kind: 'magic_get_is_master' };
		case 'magic_get_sync_status':
			return { kind: 'magic_get_sync_status' };
		// AI Agent 语义化操作
		case 'magic_get_browser':
			return { kind: 'magic_get_browser', browser_id: '' };
		case 'magic_click_at':
			return { kind: 'magic_click_at', grid: '1280,800', position: '640,400' };
		case 'magic_click_element':
			return { kind: 'magic_click_element', target: 'reload_button' };
		case 'magic_get_ui_elements':
			return { kind: 'magic_get_ui_elements' };
		case 'magic_navigate_to':
			return { kind: 'magic_navigate_to', url: 'https://' };
		case 'magic_query_dom':
			return { kind: 'magic_query_dom', by: 'css', selector: '' };
		case 'magic_click_dom':
			return { kind: 'magic_click_dom', by: 'css', selector: '' };
		case 'magic_fill_dom':
			return { kind: 'magic_fill_dom', by: 'css', selector: '', value: '' };
		case 'magic_send_keys':
			return { kind: 'magic_send_keys', keys: ['Enter'] };
		case 'magic_get_page_info':
			return { kind: 'magic_get_page_info' };
		case 'magic_scroll':
			return { kind: 'magic_scroll', direction: 'down', distance: '300' };
		case 'magic_set_dock_icon_text':
			return { kind: 'magic_set_dock_icon_text', text: '' };
		case 'magic_get_page_content':
			return { kind: 'magic_get_page_content', mode: 'interactive' };
		case 'cdp_get_cookies':
			return { kind: 'cdp_get_cookies' };
		case 'cdp_set_cookie':
			return { kind: 'cdp_set_cookie', name: '', value: '' };
		case 'cdp_delete_cookies':
			return { kind: 'cdp_delete_cookies', name: '' };
		case 'cdp_get_local_storage':
			return { kind: 'cdp_get_local_storage' };
		case 'cdp_set_local_storage':
			return { kind: 'cdp_set_local_storage', key: '', value: '' };
		case 'cdp_get_session_storage':
			return { kind: 'cdp_get_session_storage' };
		case 'cdp_clear_storage':
			return { kind: 'cdp_clear_storage' };
		case 'cdp_get_current_url':
			return { kind: 'cdp_get_current_url' };
		case 'cdp_get_page_source':
			return { kind: 'cdp_get_page_source' };
		case 'cdp_wait_for_navigation':
			return { kind: 'cdp_wait_for_navigation', timeout_ms: 30000 };
		case 'cdp_emulate_device':
			return { kind: 'cdp_emulate_device', width: 375, height: 812 };
		case 'cdp_set_geolocation':
			return { kind: 'cdp_set_geolocation', latitude: 0, longitude: 0 };
		case 'cdp_set_user_agent':
			return { kind: 'cdp_set_user_agent', user_agent: '' };
		case 'cdp_get_element_box':
			return { kind: 'cdp_get_element_box', selector: '' };
		case 'cdp_highlight_element':
			return { kind: 'cdp_highlight_element', selector: '' };
		case 'cdp_mouse_move':
			return { kind: 'cdp_mouse_move', x: 0, y: 0 };
		case 'cdp_drag_and_drop':
			return { kind: 'cdp_drag_and_drop' };
		case 'cdp_select_option':
			return { kind: 'cdp_select_option', selector: '' };
		case 'cdp_check_checkbox':
			return { kind: 'cdp_check_checkbox', selector: '' };
		case 'cdp_block_urls':
			return { kind: 'cdp_block_urls', patterns: [''] };
		case 'cdp_pdf':
			return { kind: 'cdp_pdf' };
		case 'cdp_intercept_request':
			return { kind: 'cdp_intercept_request', url_pattern: '*', action: 'block' };
		case 'cdp_get_console_logs':
			return { kind: 'cdp_get_console_logs' };
		case 'cdp_get_network_requests':
			return { kind: 'cdp_get_network_requests' };
		case 'magic_get_maximized':
			return { kind: 'magic_get_maximized' };
		case 'magic_get_minimized':
			return { kind: 'magic_get_minimized' };
		case 'magic_get_fullscreen':
			return { kind: 'magic_get_fullscreen' };
		case 'magic_get_window_state':
			return { kind: 'magic_get_window_state' };
		case 'magic_import_cookies':
			return { kind: 'magic_import_cookies', cookies: [] };
		case 'app_run_script':
			return { kind: 'app_run_script', script_id: '' };
		case 'captcha_detect':
			return { kind: 'captcha_detect' };
		case 'captcha_solve':
			return { kind: 'captcha_solve', captcha_type: 'auto' };
		case 'captcha_inject_token':
			return { kind: 'captcha_inject_token', type: '', token: '' };
		case 'captcha_solve_and_inject':
			return { kind: 'captcha_solve_and_inject' };
		case 'captcha_get_balance':
			return { kind: 'captcha_get_balance' };
		default:
			return { kind: 'wait', ms: 1000 };
	}
}
...
export const STEP_TOOL_INFO: Record<string, StepToolInfo> = {
	...
	cdp_navigate: {
		...
		inputs: [{ name: 'url', desc: '目标网址（支持变量插值）', required: true }],
		outputs: [{ name: 'output_key', desc: '返回的 target_id（可选）' }],
		whenToUse:
			'需要打开新页面或跳转到其他网址时使用。注意：不会自动等待加载完成，需配合 cdp_wait_for_page_load',
	...
	cdp_type: {
		...
		outputs: [],
		whenToUse:
			'在输入框中输入文本。触发 focus、input 事件，但不触发 keydown/keyup。React/Vue 受控组件建议用 cdp_set_input_value',
	...
	cdp_get_text: {
		...
		inputs: [{ name: 'selector', desc: '目标元素选择器', required: true }],
	...
	cdp_screenshot: {
		...
		inputs: [{ name: 'output_path', desc: '保存路径（可选，默认存变量）', required: false }],
		outputs: [
	...
	cdp_wait_for_page_load: {
		...
		inputs: [{ name: 'timeout_ms', desc: '超时毫秒数（默认 30000）', required: false }],
		outputs: [],
	...
	cdp_press_key: {
		description: '模拟单个按键',
		inputs: [{ name: 'key', desc: '按键名（Enter、Tab、Escape、ArrowDown 等）', required: true }],
		outputs: [],
	...
	wait: {
		...
		inputs: [{ name: 'ms', desc: '等待毫秒数', required: true }],
		outputs: [],
	...
	confirm_dialog: {
		...
		example:
			'message: "检测到验证码，是否继续？", buttons: [{text:"继续", value:"yes"}, {text:"停止", value:"no"}]',
	},
	// 扩展步骤
	cdp_reload: {
		description: '刷新当前页面',
		inputs: [{ name: 'ignore_cache', desc: '是否忽略缓存（强制刷新）', required: false }],
		outputs: [],
	...
	cdp_go_back: {
		description: '浏览器后退导航',
		inputs: [{ name: 'steps', desc: '后退步数（默认 1）', required: false }],
		outputs: [],
	...
	cdp_go_forward: {
		description: '浏览器前进导航',
		inputs: [{ name: 'steps', desc: '前进步数（默认 1）', required: false }],
		outputs: [],
	...
	cdp_switch_tab: {
		...
		inputs: [{ name: 'target_id', desc: '目标标签页 ID', required: true }],
		outputs: [],
	...
	cdp_close_tab: {
		description: '关闭指定标签页',
		inputs: [{ name: 'target_id', desc: '要关闭的标签页 ID', required: true }],
		outputs: [],
	...
	cdp_download_file: {
		...
		inputs: [{ name: 'download_path', desc: '下载保存目录', required: false }],
		outputs: [],
	...
	cdp_clipboard: {
		...
		inputs: [{ name: 'action', desc: '操作类型：copy/paste/selectAll', required: true }],
		outputs: [],
		whenToUse: '执行剪贴板相关操作',
		example: 'action: "copy"',
	},
	...
	cdp_delete_cookies: {
		...
		inputs: [{ name: 'name', desc: '要删除的 Cookie 名称', required: true }],
		outputs: [],
	...
	cdp_block_urls: {
		...
		inputs: [{ name: 'patterns', desc: 'URL 匹配模式数组', required: true }],
		outputs: [],
	...
	cdp_pdf: {
		...
		inputs: [{ name: 'path', desc: '保存路径（可选）', required: false }],
	...
	cdp_get_console_logs: {
		...
		inputs: [{ name: 'level', desc: '日志级别过滤（可选）', required: false }],
	...
	cdp_get_network_requests: {
		...
		inputs: [{ name: 'url_pattern', desc: 'URL 过滤模式（可选）', required: false }],
	...
	magic_close_tab: {
		...
		inputs: [{ name: 'tab_id', desc: '标签页 ID', required: true }],
		outputs: [],
		whenToUse: '关闭指定标签页',
		example: 'tab_id: 123',
	},
	...
	magic_get_tabs: {
		...
		inputs: [{ name: 'browser_id', desc: '浏览器 ID', required: true }],
		outputs: [{ name: 'output_key', desc: '标签页信息数组' }],
	...
	magic_type_string: {
		...
		inputs: [{ name: 'text', desc: '要输入的文本', required: true }],
		outputs: [],
	...
	magic_trigger_extension_action: {
		description: '触发扩展动作',
		inputs: [{ name: 'extension_id', desc: '扩展 ID', required: true }],
		outputs: [],
	...
	magic_export_cookie_state: {
		...
		inputs: [{ name: 'mode', desc: '导出模式：all/current', required: false }],
	...
	magic_toggle_sync_mode: {
		description: '切换同步模式',
		inputs: [{ name: 'role', desc: '角色：master/slave/off', required: true }],
		outputs: [],
		whenToUse: '切换窗口同步模式',
		example: 'role: "master"',
	},
	...
	magic_get_browser: {
		description: '读取指定浏览器窗口的当前状态，便于在多实例场景里精确定位目标实例。',
		inputs: [{ name: 'browser_id', desc: '目标浏览器窗口 ID', required: true }],
		outputs: [{ name: 'output_key', desc: '浏览器窗口的详细状态信息' }],
		whenToUse: '当你已经拿到 browser_id，想确认该实例的标题、标签页或窗口状态时使用。',
		example: 'browser_id: 123',
	},
	magic_click_at: {
		description: '按虚拟坐标点击浏览器窗口中的任意可见区域，覆盖标签栏、地址栏、扩展栏和网页内容。',
		inputs: [
			{ name: 'grid', desc: '虚拟坐标系大小，格式如 "1000,1000"', required: true },
			{ name: 'position', desc: '点击位置，格式如 "500,50"', required: true },
			{ name: 'button', desc: '鼠标按钮：left/right/middle，默认 left', required: false },
			{ name: 'action', desc: '动作：click/down/up/move，默认 click', required: false },
			{ name: 'click_count', desc: '点击次数，双击可传 2', required: false },
			{ name: 'modifiers', desc: '修饰键数组，如 ["meta"]', required: false },
			{ name: 'browser_id', desc: '目标浏览器窗口 ID', required: false },
		],
		outputs: [],
		whenToUse: '语义化 API 无法覆盖目标 UI 时，用它做最后兜底；通常建议先配合截图确认坐标。',
		example: 'grid: "1000,1000", position: "500,57", button: "left", browser_id: 123',
	},
	magic_click_element: {
		description: '按语义标识点击浏览器自身的 Chrome UI 元素，无需截图或坐标换算。',
		inputs: [
			{ name: 'target', desc: '目标标识，如 back_button / reload_button / tab:1', required: true },
			{ name: 'browser_id', desc: '目标浏览器窗口 ID', required: false },
		],
		outputs: [],
		whenToUse: '点击后退、前进、刷新、地址栏、标签页或应用菜单等浏览器原生控件时优先使用。',
		example: 'target: "forward_button", browser_id: 123',
	},
	magic_get_ui_elements: {
		description:
			'读取浏览器 UI 当前状态，返回工具栏按钮、标签页列表和菜单信息，供脚本先判断再决策。',
		inputs: [{ name: 'browser_id', desc: '目标浏览器窗口 ID', required: false }],
		outputs: [{ name: 'output_key', desc: '工具栏、标签栏和菜单的结构化状态' }],
		whenToUse: '需要先判断按钮是否可点、哪个标签页处于激活状态，或应用菜单是否已经展开时使用。',
		example: 'browser_id: 123',
	},
	magic_navigate_to: {
		description: '让当前或指定标签页导航到目标 URL，走浏览器正常导航链路。',
		inputs: [
			{ name: 'url', desc: '完整目标地址，需包含协议头', required: true },
			{ name: 'tab_id', desc: '目标标签页 ID，省略时使用活动标签页', required: false },
		],
		outputs: [],
		whenToUse: '需要显式打开某个网址，或在多标签脚本里让指定 tab 跳转到新页面时使用。',
		example: 'url: "https://example.com/login", tab_id: 456',
	},
	magic_query_dom: {
		description: '在页面中查询 DOM 元素，返回候选列表和索引，方便后续点击、填写或滚动。',
		inputs: [
			{
				name: 'by',
				desc: '查询方式：css/xpath/text/aria/role/placeholder/name/search/idx',
				required: true,
			},
			{ name: 'selector', desc: '查询表达式或 idx 值', required: true },
			{ name: 'match', desc: '匹配模式，如 contains / icontains / exact / regex', required: false },
			{ name: 'index', desc: '当 by=idx 之外又需锁定多候选时指定第几个', required: false },
			{ name: 'limit', desc: '最多返回多少个候选元素', required: false },
			{ name: 'visible_only', desc: '是否仅返回可见元素，默认 true', required: false },
			{ name: 'tab_id', desc: '目标标签页 ID', required: false },
		],
		outputs: [{ name: 'output_key', desc: '候选元素列表，含 index、文本、可见性和位置信息' }],
		whenToUse: '在点击或填写前先探查页面元素，尤其适合存在多个相似按钮、输入框或文本节点的场景。',
		example: 'by: "placeholder", selector: "Search Wikipedia", limit: 5',
	},
	magic_click_dom: {
		description:
			'按选择器或 idx 点击页面 DOM 元素，底层会注入真实鼠标事件而不是直接调用 el.click()。',
		inputs: [
			{ name: 'by', desc: '定位方式，支持 css/text/aria/role/search/idx 等', required: true },
			{ name: 'selector', desc: '选择器表达式或 idx 值', required: true },
			{ name: 'match', desc: '匹配模式，和 query_dom 一致', required: false },
			{ name: 'index', desc: '多候选时点击第几个，默认 0', required: false },
			{ name: 'visible_only', desc: '是否仅在可见元素中查找，默认 true', required: false },
			{ name: 'tab_id', desc: '目标标签页 ID', required: false },
		],
		outputs: [],
		whenToUse:
			'需要真正模拟用户点击网页元素，尽量绕过前端框架或反自动化对 el.click() 的限制时使用。',
		example: 'by: "idx", selector: "5"',
	},
	magic_fill_dom: {
		description: '定位并填写表单元素，支持先清空再输入，适用于 input、textarea 等表单控件。',
		inputs: [
			{
				name: 'by',
				desc: '定位方式，支持 css/text/placeholder/name/search/idx 等',
				required: true,
			},
			{ name: 'selector', desc: '选择器表达式或 idx 值', required: true },
			{ name: 'value', desc: '要填入的文本内容', required: true },
			{ name: 'match', desc: '匹配模式，和 query_dom 一致', required: false },
			{ name: 'index', desc: '多候选时填写第几个，默认 0', required: false },
			{ name: 'clear', desc: '填写前是否清空原有内容，默认 true', required: false },
			{ name: 'visible_only', desc: '是否仅在可见元素中查找，默认 true', required: false },
			{ name: 'tab_id', desc: '目标标签页 ID', required: false },
		],
		outputs: [],
		whenToUse:
			'自动填写登录框、搜索框或表单字段时使用；配合 query_dom / get_page_content 能更稳地选中目标。',
	...
	magic_send_keys: {
		...
		inputs: [
			{
				name: 'keys',
				desc: '按键数组，如 ["meta+l", "https://example.com", "Return"]',
				required: true,
			},
			{ name: 'tab_id', desc: '目标标签页 ID，省略时使用活动标签页', required: false },
			{
	...
	magic_get_page_info: {
		...
		inputs: [{ name: 'tab_id', desc: '目标标签页 ID，省略时使用活动标签页', required: false }],
		outputs: [
			{ name: 'output_key', desc: '页面状态对象，含 url/title/loading/ready_state/scroll 等字段' },
		],
		whenToUse:
			'执行页面动作前后做状态确认，判断页面是否加载完成、是否出现对话框，或记录当前滚动位置时使用。',
		example: 'tab_id: 456',
	},
	magic_scroll: {
		description: '滚动页面到指定方向，或滚动到特定 DOM 元素所在位置。',
		inputs: [
			{ name: 'direction', desc: '方向模式：up/down/left/right/top/bottom', required: false },
			{ name: 'distance', desc: '方向滚动的像素距离，默认 300', required: false },
			{ name: 'by', desc: '元素滚动模式的定位方式，如 css/text/idx', required: false },
			{ name: 'selector', desc: '元素滚动模式的选择器或 idx 值', required: false },
			{ name: 'index', desc: '多候选元素时选第几个，默认 0', required: false },
			{ name: 'visible_only', desc: '元素滚动模式下是否仅查找可见元素', required: false },
			{ name: 'tab_id', desc: '目标标签页 ID', required: false },
		],
		outputs: [{ name: 'output_key', desc: '新的滚动位置，如 scrollX / scrollY / scrollHeight' }],
		whenToUse: '页面较长、目标元素暂不在视口内，或需要回到顶部/底部继续执行操作时使用。',
		example: 'direction: "down", distance: 500 或 by: "css", selector: "footer"',
	},
	magic_set_dock_icon_text: {
		description: '为 macOS Dock 图标设置底部文字标签，用于区分多实例浏览器窗口。',
		inputs: [
			{ name: 'text', desc: '要显示的标签文字；传空字符串可清除', required: true },
			{ name: 'color', desc: '可选文字颜色，格式为 #RRGGBB', required: false },
		],
		outputs: [{ name: 'output_key', desc: '当前生效的标签文字和颜色' }],
		whenToUse: '同一台机器同时开多个浏览器实例时，用于在 Dock 中快速区分账号、环境或任务编号。',
		example: 'text: "亚马逊-001", color: "#FF6600"',
	},
	magic_get_page_content: {
		description:
			'获取页面语义快照，可返回交互元素、文本内容、无障碍树或完整页面结构，并自动生成可复用的 idx 引用。',
		inputs: [
			{ name: 'mode', desc: '提取模式：summary/interactive/content/a11y/full', required: false },
			{ name: 'format', desc: '输出格式：json 或 text', required: false },
			{ name: 'tab_id', desc: '目标标签页 ID', required: false },
			{ name: 'viewport_only', desc: '是否只返回当前视口内的内容', required: false },
			{ name: 'max_elements', desc: '最大元素数，控制结果体积', required: false },
			{ name: 'max_text_length', desc: '单段文本截断长度', required: false },
			{ name: 'regions', desc: '仅提取指定 landmark 区域', required: false },
			{ name: 'exclude_regions', desc: '排除指定 landmark 区域', required: false },
		],
		outputs: [
			{ name: 'output_key', desc: '页面语义快照；interactive/full 模式下会返回 idx 引用信息' },
		],
		whenToUse:
			'给 AI 或脚本先“读懂页面”再决定下一步操作，特别适合复杂表单、长页面或需要节省 token 的场景。',
		example: 'mode: "interactive", format: "text", regions: ["main"]',
	},
	// 其他常用步骤
	select_dialog: {
	...
	wait_for_user: {
		...
		inputs: [{ name: 'message', desc: '提示消息', required: false }],
		outputs: [],
	...
	continue: {
		...
		description: '结束脚本执行',
		inputs: [{ name: 'message', desc: '结束消息（可选）', required: false }],
		outputs: [],
		whenToUse: '提前终止脚本执行',
	...
	captcha_solve: {
		description: '求解验证码',
		inputs: [{ name: 'captcha_type', desc: '验证码类型', required: false }],
	...
	app_run_script: {
		...
		inputs: [{ name: 'script_id', desc: '脚本ID', required: true }],
		outputs: [],
