							...
							>
								<ConsolePageContent
									...
									actions={{
										...
										purgeGroup: consoleState.purgeGroup,
										...
										purgeProfile: consoleState.purgeProfile,
										refreshGroups: consoleState.refreshGroups,
										refreshProfiles: consoleState.refreshProfiles,
										createProxy: consoleState.createProxy,
										updateProxy: consoleState.updateProxy,
										deleteProxy: consoleState.deleteProxy,
										batchDeleteProxies: consoleState.batchDeleteProxies,
										batchUpdateProxies: consoleState.batchUpdateProxies,
										importProxies: consoleState.importProxies,
										checkProxy: consoleState.checkProxy,
										batchCheckProxies: consoleState.batchCheckProxies,
										restoreProxy: consoleState.restoreProxy,
										purgeProxy: consoleState.purgeProxy,
