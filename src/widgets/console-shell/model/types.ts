...
export type ConsolePageActions = {
	...
	updateGroup: (groupId: string, name: string, note: string) => Promise<void> | void;
	...
	setProfileGroup: (profileId: string, groupName?: string) => Promise<void>;
	...
	batchSetProfileGroup: (profileIds: string[], groupName?: string) => Promise<BatchProfileActionResponse>;
