import type { ProfileItem, ResourceItem } from '../types';
import type { PlatformVisualMeta } from './platform-meta';
...
export function resolveBrowserVersionMeta(
	...
	return {
		...
		resourceLabel: resource ? (resource.installed ? '已安装' : '未下载，启动时自动下载') : '当前宿主系统无该版本资源',
	};
}
