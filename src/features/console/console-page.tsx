...
import { ConsoleSidebar, ConsoleTopbar } from './components';
import { useConsoleState, useThemeSettings } from './hooks';
import {
	isConsolePath,
	NAV_PATHS,
...
const GroupsPage = lazy(() =>
	import('./pages/groups-page').then((module) => ({ default: module.GroupsPage })),
);
const ProxyPage = lazy(() =>
	import('./pages/proxy-page').then((module) => ({ default: module.ProxyPage })),
);
const WindowsPage = lazy(() =>
	import('./pages/windows-page').then((module) => ({ default: module.WindowsPage })),
);
const AiPage = lazy(() =>
	import('./pages/ai-page').then((module) => ({ default: module.AiPage })),
);
const SettingsPage = lazy(() =>
	import('./pages/settings-page').then((module) => ({ default: module.SettingsPage })),
);
const RecycleBinPage = lazy(() =>
	import('./pages/recycle-bin-page').then((module) => ({ default: module.RecycleBinPage })),
);
