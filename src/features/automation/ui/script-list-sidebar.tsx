...
export function ScriptListSidebar({ scripts, selectedScriptId, onSelect, onNew, onImport }: Props) {
	const { t } = useTranslation('automation');
	const { filtered, searchQuery, setSearchQuery } = useScriptListFilter(scripts);
